      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed">
            Build powerful MCP server management interfaces with our React
            component library
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6 rounded-lg border border-border bg-card">
              ...
              <p className="text-muted-foreground">
                Full-featured chat components with message history, streaming
            ...
            <div className="p-6 rounded-lg border border-border bg-card">
              ...
              <p className="text-muted-foreground">
                Complete MCP server directory, configuration, and management
                tools with real-time status updates.
              </p>
            </div>
            <div className="p-6 rounded-lg border border-border bg-card">
              ...
              <p className="text-muted-foreground">
                Docker-based local toolbox with installation flows, status
            ...
            <div className="p-6 rounded-lg border border-border bg-card">
              ...
              <p className="text-muted-foreground">
                Highly configurable components with themes, proxy URLs, and
                feature toggles for any use case.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Complete installation flow for Docker-based local toolbox
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Real-time status indicators for local toolbox connection,
                    Docker health, and MCP proxy.
                  </p>
                </div>
              </div>
            </div>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Hook for direct MCP server management with WebSocket
                    connections and real-time updates.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Improved chat container with session management, model
                    configuration, and enhanced UI.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Status badges, configuration drawers, and other specialized
                    UI components for MCP interfaces.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            ...
            <div className="bg-secondary rounded-md p-4 mb-6">
              <code className="text-sm">npm install @nullshot/playground</code>
            </div>
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Explore our enhanced playground components and see how easy it is to
            build complete MCP interfaces.
          </p>
