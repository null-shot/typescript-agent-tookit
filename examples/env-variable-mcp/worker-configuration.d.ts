/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 77bbba2015ef11e2d754e5e368982275)
// Runtime types generated with workerd@1.20250917.0 2025-04-17 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EnvVariableMcpServer";
	}
	interface Env {
		DEFAULT_NAME: "World";
		ENV_VARIABLE_MCP_SERVER: DurableObjectNamespace<import("./src/index").EnvVariableMcpServer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_NAME">> {}
}
