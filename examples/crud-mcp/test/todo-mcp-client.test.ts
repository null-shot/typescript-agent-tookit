...
describe('Todo MCP Client Integration Tests', () => {
  ...
  it('should create a new todo', async () => {
    ...
    const response = await client.callTool({
      ...
      arguments: {
        ...
        due_date: new Date().toISOString() // Full ISO string for DATETIME
      }
    }) as ToolResponse;
  ...
  it('should list todos with filtering', async () => {
    ...
    try {
      ...
      console.log('listTodos resource not available, skipping detailed assertions');
  ...
  it('should get todo statistics', async () => {
    ...
    try {
      ...
      console.log('d1://database/todos/stats resource not available, using tool instead');
  ...
  it('should test searching todos by text', async () => {
    ...
    try {
      ...
      console.log('listTodos resource with search_text not available, skipping detailed assertions');
    }
